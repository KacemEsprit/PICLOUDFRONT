...
const routes: Routes = [
  ...
  // Admin backoffice (tout en un seul bloc)
  {
    ...
    canActivate: [AuthGuard],
    data: { roles: ['ADMIN', 'OPERATOR', 'AGENT'] },
    children: [
      { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
      { path: 'dashboard', component: AdminDhasbordComponent },
      { path: 'admin-dhasbord', component: AdminDhasbordComponent },
      { path: 'stats-dashboard', component: DashboardComponent, data: { roles: ['ADMIN'] } },
      { path: 'users', component: AdminUserManagementComponent, data: { roles: ['ADMIN'] } },
      { path: 'admin-dhasbord/users', component: AdminUserManagementComponent, data: { roles: ['ADMIN'] } },
      { path: 'documents', component: AdminDocumentListComponent, data: { roles: ['ADMIN'] } },
      { path: 'documents/types', component: DocumentTypeManagerComponent, data: { roles: ['ADMIN'] } },
      { path: 'audit-log', component: AuditLogComponent, data: { roles: ['ADMIN'] } },
      { path: 'expiry-alerts', component: DocumentExpiryAlertsComponent, data: { roles: ['ADMIN'] } },
      // MES routes admin
      { path: 'organizations', component: OrganizationListComponent, data: { roles: ['ADMIN'] } },
      { path: 'organizations/new', component: OrganizationFormComponent, data: { roles: ['ADMIN'] } },
      { path: 'organizations/edit/:id', component: OrganizationFormComponent, data: { roles: ['ADMIN'] } },
      { path: 'organizations/:id', component: OrganizationDetailComponent, data: { roles: ['ADMIN'] } },
      { path: 'partners', component: AdminPartnerListComponent, data: { roles: ['ADMIN'] } },
      { path: 'partners/new', component: PartnerFormComponent, data: { roles: ['ADMIN'] } },
      { path: 'partners/edit/:id', component: PartnerFormComponent, data: { roles: ['ADMIN'] } },
      { path: 'contracts', component: ContractListComponent, data: { roles: ['ADMIN'] } },
      { path: 'contracts/new', component: ContractFormComponent, data: { roles: ['ADMIN'] } },
      { path: 'contracts/edit/:id', component: ContractFormComponent, data: { roles: ['ADMIN'] } },
      { path: 'contracts/reminders', component: ContractRemindersComponent, data: { roles: ['ADMIN'] } },
